...
$db = mysqli_select_db($conexion, $basededatos) or die ("Error conexion al conectarse a la Base de datos");
    ...
    //sentencia sql
    $sql="INSERT INTO datos VALUES ('$nombre','$tamaño','$cantidad','$direccion','$telefono')"; //manda a traer los valores de '$nombre','$correo','$mensaje'
    ...
    if(!$ejecutar){
         ...
         echo "<script>location.href='compra.html'</script>";	
    }else{
